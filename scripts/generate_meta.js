...
async function main() {
    ...
    const contractArtifact = require(path.join(process.cwd(), contractDir, "DelegateRegistry.json"));
    ...
    log('Write DelegateRegistryMeta.json');
    const contractMetaFile = path.join(process.cwd(), metaDir, "DelegateRegistryMeta.json");
    await writeFile(contractMetaFile, contractArtifact.metadata)

    log('Write DelegateRegistryEtherscan.json');
    const contractEtherscanFile = path.join(process.cwd(), metaDir, "DelegateRegistryEtherscan.json");
